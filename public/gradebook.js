function fetchGradeData(){
    // This function will query the PostgreAQL database and return gradedata
    console.log("Fetching grade data...");
    //Create a new request for HTTP data
    let xhr = new XMLHttpRequest();
    // This is the address on the machine we'rea asking for data
...
function populateGradebook(data) {
    // This function will take the fetched grade data nad populate the table
    ...
    data.forEach(function(assignment){ // For each row of data we're passed in})
        ...
        columns.name = document.createElement('td'); // second column will be the grade
